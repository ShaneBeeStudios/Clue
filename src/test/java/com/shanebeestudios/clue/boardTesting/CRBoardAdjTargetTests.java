...
public class CRBoardAdjTargetTests {
	...
	{
		// Test on top edge of com.shanebeestudios.clue.board, just one walkway piece
		LinkedList<Integer> testList = board.getAdjList(board.calcIndex(0, 4));
		Assert.assertTrue(testList.contains(5));
		Assert.assertEquals(1, testList.size());
		
		// Test on left edge of com.shanebeestudios.clue.board, three walkway pieces
		...
		// Test on bottom edge of com.shanebeestudios.clue.board, next to 1 room piece
		...
		// Test on right edge of com.shanebeestudios.clue.board, next to 1 room piece
	...
	// Tests of just walkways, 1 step, includes on edge of com.shanebeestudios.clue.board
	// and beside room
