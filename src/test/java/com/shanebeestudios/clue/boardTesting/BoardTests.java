 ...
 * This class encompasses the testing of the main clue com.shanebeestudios.clue.board implementation
...
public class BoardTests {
	...
	// Create a new com.shanebeestudios.clue.board, static so that it may be used across all functions
	static Board newBoard;
	
	// BeforeClass method. Runs at the start of the test suite so that the com.shanebeestudios.clue.board is properly initialized before the tests are run.
	...
	// Testing suite for assuring that the initial of the cells is correctly read and displayed on the com.shanebeestudios.clue.board
	@Test
